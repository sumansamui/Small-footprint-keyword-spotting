    ...
    with tf.device("GPU"):
        ...
        with open(file_path, "r") as f:
            for line in f:
                ...
                decoded, sample = load_wav_file(wav, FLAGS.sample_rate)                 #(FLAGS.wav, FLAGS.sample_rate)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--labels', type=str, default='ds_cnn_s/validation_utils/labels.txt', help='Path to file containing labels.')
    parser.add_argument(
        '--sample_rate',
        type=int,
        default=16000,
    ...
    parser.add_argument(
        '--keras_file_path',
        type=str,
        default='ds_cnn_s/keras/ds_cnn.h5',
