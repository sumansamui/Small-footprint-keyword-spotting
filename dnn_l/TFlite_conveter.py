...
# Parameters
keras_model_filename = 'dnn_l/keras/dnn.h5'
tflite_filename = 'dnn_l/keras/dnn_l_quantized.tflite'
tflite_int8_filename = 'dnn_l/keras/dnn_l_int8_quantized.tflite'

# Convert model to TF Lite model
model = models.load_model(keras_model_filename)
converter = lite.TFLiteConverter.from_keras_model(model)
tflite_model = converter.convert()
#print(tflite_model.dtype)
