...
keras_model_filename = 'cnn_small/keras/cnn.h5'
tflite_filename = 'cnn_small/keras/cnn_s_quantized.tflite'
tflite_int8_filename = 'cnn_small/keras/cnn_s_quantized_int8_quantized.tflite'
