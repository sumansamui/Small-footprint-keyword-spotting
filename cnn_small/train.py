...
def train():
    ...
    # # Parameters
    # keras_model_filename = 'E:/OneDrive - NIT Durgapur/Program/ML_ZOO/ML-zoo-master/models/keyword_spotting/train/cnn_small/keras/cnn.h5'
    # tflite_filename = 'E:/OneDrive - NIT Durgapur/Program/ML_ZOO/ML-zoo-master/models/keyword_spotting/train/cnn_small/keras/cnn_s_quantized.tflite'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default= '10000,10000,10000',          # '15000,3000',
    ...
    parser.add_argument(
        '--train_dir',
        type=str,
        default='cnn_small/speech_commands_train',
